...
* 2013年进入河南科技大学大学学习
* 2015年投入web学习
* 2016年-2017年加入创业团队，系阿蒲猫前端开发
* 2018年6月就职于洛阳矩阵软件有限公司
* 2019年7月成长为公司前端组长
...
### 【教科研管理系统】
- 简介
  + 教科研管理系统采用了vue-cli的方式进行开发，使用了Element组件
- 项目收获
  + Element上传组件的再封装,自定义文件上传方法
  + 封装Axios请求库，实现对请求（request）及响应（response）的统一拦截处理

### 【课程发展中心】
- 简介
  + 课程发展中心采用了vue-cli的方式进行开发，使用了Element组件
- 项目收获
  + 对页面进行深度优化，提高页面加载速度
  
### 【企业数据大屏】
- 简介
  + 某跨国企业国内总部数据大屏开发工作，该大屏展示三维地球，并在地球上展示该企业的项目。
- 项目收获
  + 对WebGL封装库Three.js的使用，封装了经纬度坐标转换三维立体坐标的方法，并实现了地球的定点旋转
  + 对三维模型的材质、光线、贴图产生了深刻的认识
  + 设计算法实现循环的时间轴
  
### 【货运平台App】
- 简介
  + 项目是在App中内嵌WebView，主要制作的是WebView中的H5页面。
- 项目收获
  + 通过Bridge桥接方式与安卓、Ios原生进行交互；
  + 对项目架构进行设计，封装统一的Bridge方法；
  
## 小型业务

### 【校历】
针对教师、学生的课程、会议等信息进行日历形式的展示，并能为每个用户提供新增会议、日程的功能。

### 【疫情状态统计】
针对2020年初的疫情对教师及学生进行状态的填报，以及对实时数据的展示，主要解决了在各个设备中的兼容性问题。

## 团队建设工作

### 【建立工作规范】
- 背景
  + 在工作中建立良好的工作规范，有利于团队工作的效率以及更好的后期维护。
- 建立的工作规范有：
  + 命名规范
  + UI样式规范
  + 注释规范
...
### 【建立前端团队工作进度监督制度】
- 内容
  + 在实际工作中，每天早上用十分钟时间简单说下现在手头的工作进度，并将新的任务下放，根据进度及时调整团队的开发方式以提高效率。
